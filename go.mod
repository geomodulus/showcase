module github.com/geomodulus/showcase

go 1.20

require (
	github.com/geomodulus/citygraph v0.0.0-20230810194445-8a1e6a1aa449
	github.com/geomodulus/robots v0.0.0-20230811180645-eedd06db349a
...
require (
	...
	github.com/nekomeowww/go-pinecone v0.1.0 // indirect
